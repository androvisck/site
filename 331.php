		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>3.31 - Participação em Ação/Projeto/Programa Institucional: de Área, de Gestão do PIBID CAPES, Observatório Educacional, Rede Cedes e Programa de Educação Tutorial nas diversas áreas (PET) e similares, desde que aprovada por algum colegiado da UPE.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Ação/Projeto/Programa"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Área"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
						...
						<?php // onclick="window.open('upload4.php', '_blank');"  
							...
							{								
								if(($_FILES['image']['size'] == 0) || (empty($_POST['ano'])) || (empty($_POST['semestre'])))
								{
									...
									$ano = $_POST['ano'];
									$n1 = $_POST['nome'];
									$nome = '<b>Ação/Projeto/Programa:</b>' . '  ' . $n1;
									$n2 = $_POST['nome1'];
									$nome1 = '<b>Área:</b>' . '  ' . $n2;
