		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>3.28 - Apresentação de trabalho, palestra ou mesa redonda em evento de extensão.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Título do Trabalho/Palestra/Mesa Redonda"/></tr>
