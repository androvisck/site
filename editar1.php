				...
				<div id="vip" style="margin:auto" align=center>
					...
					<?php
						...
						{		
							...
							if($arquivo == "")
								{
									$sql_code ="UPDATE banco SET nome='$nome', ano='$ano', semestre='$semestre', modificado=NOW() WHERE id='$id'";
								...
								if(isset($_FILES['image']))
								{
									...
									if(!preg_match('/^image\/(?:jpg|jpeg|png)$/i', $_FILES['image']['type'])){;
										$sql_code1 ="UPDATE banco SET nome='$nome', ano='$ano', semestre='$semestre', foto = NULL, pdf = '$imagem', modificado=NOW() WHERE id='$id'";
										...
										$sql_code1 ="UPDATE banco SET nome='$nome', ano='$ano', semestre='$semestre', foto = '$imagem', pdf = NULL, modificado=NOW() WHERE id='$id'";
										mysqli_query($conexao, $sql_code1);
