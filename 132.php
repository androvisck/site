		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>1.32 - Participação em Projeto de Ensino COM fomento externo à UPE.</h2>
								   ...
								   ?><table><br><hr>
										...
										<td align="left"><?php 
											...
											<td><?php 	
													...
													$var3 = $row["ano"];
													$var4 = $row["semestre"];
													$varZ = sprintf("<b>Descrição: </b>%s<br> <b>Edital: </b>%s<br> <b>ANO: </b>%s<br> <b>SEMESTRE: </b>%s", $var1, $var2, $var3, $var4);
													echo $varZ;
												?>
											</td><br>
										</tr>
