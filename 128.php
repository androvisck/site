		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>1.28 - Supervisão de estágio docente de estudante de stricto sensu da UPE.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Nome do Estudante"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Curso"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
