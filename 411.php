		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>4.11 - Membro de Comissão/Comitê/Núcleo, formalmente designado(a) no âmbito da UPE.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Comissão/Comitê/Núcleo"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
						...
						<?php // onclick="window.open('upload4.php', '_blank');"  
							...
							{								
								if(($_FILES['image']['size'] == 0) || (empty($_POST['ano'])) || (empty($_POST['semestre'])))
								{
									...
									$ano = $_POST['ano'];
									$n1 = $_POST['nome'];
									$nome = '<b>Comissão/Comitê/Núcleo:</b>' . '  ' . $n1;
