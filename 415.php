		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>4.15 - Participação como membro nas câmaras consultivas dos Conselhos Superiores.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Câmara Consultiva"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
