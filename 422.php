		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>4.22 - Membro Titular da Diretoria de entidade representativa docente.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Diretoria"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Entidade"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
