		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>3.30 - Orientação concluída de iniciação a extensão (PIBIEXT), aprovada em edital, bolsista ou voluntário(a).</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Título da Iniciação"/></tr>
