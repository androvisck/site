			...
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h1>Gestão - Gerar Relatório</h1>
								...
								<form style="width: 200px;" name="impressao" type="text" method="POST" enctype="multipart/form-data" value="<?php echo $ano;?>" action="i_gestao.php" target="_blank"/>
