		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>2.31 - Registro de patente.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Título da Patente"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Número da Patente"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
