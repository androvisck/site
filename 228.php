		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>2.28 - Publicação de resumo expandido em evento científico.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Evento"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Título da Resumo Expandido"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
