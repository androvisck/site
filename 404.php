		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>4.4 - Coordenação de gestão central, chefia de gabinete da reitoria, coordenação de NCTI (Núcleo de Comunicação e Tecnologia da Informação), CPA (Comissão Própria de Avaliação), Gestor Executivo das Unidades de Educação e Saúde e CPCA (Comissão Permanente de Co</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Setor"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
