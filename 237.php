		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>2.37 - Participação como Membro de Comitê Técnico (TPC - Technical Program Chair) ou Comissão Científica em evento científico.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Comitê Técnico ou Comissão Científica"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
