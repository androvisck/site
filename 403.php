		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>4.3 - Diretor(a) ou Vice‐Diretor(a) de Unidade de Educação ou de Educação e Saúde ou Superintendente do Complexo Hospitalar.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Instituição"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
