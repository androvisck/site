				...
				<div id="vip" style="margin:auto" align=center>
					<h2><strong>EDIÇÃO</strong></h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome2" value="<?php if(!empty($row2['nome2'])){$e=explode('  ',$row2['nome2']); echo $f=$e[1] ;}?>"></td>
							</table>
							<table width="200px">	
								<tr width="200px">
					...
					<?php
						...
						{		
							...
							if($arquivo == "")
								{
									$sql_code ="UPDATE banco SET nome='$nome', nome1='$nome1', nome2='$nome2', ano='$ano', semestre='$semestre', modificado=NOW() WHERE id='$id'";
								...
								if(isset($_FILES['image']))
								{
									...
									if(!preg_match('/^image\/(?:jpg|jpeg|png)$/i', $_FILES['image']['type'])){;
										$sql_code1 ="UPDATE banco SET nome='$nome', nome1='$nome1', nome2='$nome2', ano='$ano', semestre='$semestre', foto = NULL, pdf = '$imagem', modificado=NOW() WHERE id='$id'";
										...
										$sql_code1 ="UPDATE banco SET nome='$nome', nome1='$nome1', nome2='$nome2', ano='$ano', semestre='$semestre', foto = '$imagem', pdf = NULL, modificado=NOW() WHERE id='$id'";
										mysqli_query($conexao, $sql_code1);
