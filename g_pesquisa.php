		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h1>Pesquisa - Gerar Relatório</h1>
								...
								<form style="width: 200px;" name="impressao" type="text" method="POST" enctype="multipart/form-data" value="<?php echo $ano;?>" action="i_pesquisa.php" target="_blank"/>
