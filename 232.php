		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>2.32 - Premiação de trabalho científico ou literário.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Título da Premiação"/></tr>
						...
						<?php // onclick="window.open('upload4.php', '_blank');"  
							...
							{								
								if(($_FILES['image']['size'] == 0) || (empty($_POST['ano'])) || (empty($_POST['semestre'])))
								{
									...
									$ano = $_POST['ano'];
									$n1 = $_POST['nome'];
									$nome = '<b>Premiação:</b>' . '  ' . $n1;
									$n2 = $_POST['nome1'];
									$nome1 = '<b>Trabalho:</b>' . '  ' . $n2;
