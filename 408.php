		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>4.8 - Coodernador(a) ou vice-coordenador(a) de curso graduação ou pós-graduação lato sensu, exclusivamente na modalidade EA.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Curso"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
