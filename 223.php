		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>2.23 - Publicação científica em periódico indexado - qualis C ou sem qualis.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Nome do Periódico"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Título da Publicação"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
						...
						<?php // onclick="window.open('upload4.php', '_blank');"  
							...
							{								
								if(($_FILES['image']['size'] == 0) || (empty($_POST['ano'])) || (empty($_POST['semestre'])))
								{
									...
									$ano = $_POST['ano'];
									$n1 = $_POST['nome'];
									$nome = '<b>Periódico:</b>' . '  ' . $n1;
									$n2 = $_POST['nome1'];
									$nome1 = '<b>Publicação:</b>' . '  ' . $n2;
