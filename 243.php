		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>2.43 - Apresentação de trabalho, palestra ou mesa redonda em evento científico.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Título do Trabalho, Palestra ou Mesa Redonda"/></tr>
