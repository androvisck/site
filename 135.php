		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>1.35 - Orientação de monitoria de componente curricular ou módulo, desde que selecionado em edital da unidade.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome1"  placeholder="Edital"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
