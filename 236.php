		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>2.36 - Participação, como consultor(a) ad hoc, em comitê e conselho científico.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Comitê/Conselho Científico"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
