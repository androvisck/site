		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>4.26 - Coordenação de Núcleo Docente Estruturante ou Núcleo Docente Estruturante Assistencial.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Coordenação de Núcleo Docente"/></tr>
