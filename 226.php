...
<html lang="pt-br">
	...
	<?php echo utf8_decode($row1['titulo']) . " ". utf8_decode($row1['nome']);?> | <a href="pesquisa.php">Voltar</a></br></br><hr>
	<body>
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>2.26 - Publicação de capítulo de livro com ISBN.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Título do Livro"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Título do Capítulo"/></tr>
								<tr><input type="text" name="nome2"  placeholder="ISBN"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
