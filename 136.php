		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>1.36 - Participação em Núcleo Docente Estruturante ou Núcleo Docente Estruturante Assistencial.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Nome do Núcleo"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Departamento"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
