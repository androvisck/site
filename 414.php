		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>4.14 - Membro suplente dos Conselhos da UPE (CEPE, CONSUN ou CGA).</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Conselho (CEPE, CONSUN ou CGA)"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
