		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>2.44 - Presidência de Banca Avaliadora, Coordenação de Fórum ou Simpósio em Evento Científico.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Título da Banca Avaliadora, Coordenação de Fórum ou Simpósio"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Evento"/></tr>
							</table>
							<table width="400px">	
								<tr width="400px">
