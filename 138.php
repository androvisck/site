		...
		<div class="container" >
			<div class="content">
				<div id="vip" style="margin:auto auto" align=center>
					<h2>1.38 - Participação em banca examinadora - TCC de graduação, especialização ou residência.</h2>
						<form action="" name="CadastroAlunos" type="text" method="post" enctype="multipart/form-data">
							<table>
								...
								<tr><input type="text" name="nome"  placeholder="Título do TCC"/></tr>
								<tr><input type="text" name="nome1"  placeholder="Nome do Discente"/></tr>
